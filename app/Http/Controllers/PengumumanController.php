...
class PengumumanController extends Controller
{
    ...
    public function calculateAndReturnView()
    {
        ...
        return view('pengumuman', compact('pendaftars','kriterias','penilaians', 'utilityValues', 'finalScores', 'maxValues', 'minValues', 'bobotValues'));
    }
    ...
    public function cetakpengumuman()
    {
        ...
        return view('pengumuman-export', compact('pendaftars', 'finalScores', 'penilaians'));
    }
